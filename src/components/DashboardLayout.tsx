...
const sidebarSections: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: PencilLine, label: 'Examinations', href: '/examinations', roles: ['admin', 'teacher'] },
      { icon: Timer, label: 'Timetables', href: '/timetables', roles: ['admin', 'teacher'] },
  ...
  },
  {
    title: 'Operations',
    items: [
      { icon: Library, label: 'Library', href: '/library', roles: ['admin'] },
      { icon: Truck, label: 'Inventory', href: '/inventory', roles: ['admin'] },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: PiggyBank, label: 'Payroll', href: '/payroll', roles: ['admin'] },
    ],
  },
  {
    title: 'System',
